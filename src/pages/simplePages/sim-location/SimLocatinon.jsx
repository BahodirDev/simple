...
function SimLocatinon(props) {
    ...
    useEffect(() => {
        const storedUsers = localStorage.getItem('uchrashuv');
        if (storedUsers) {
                        ...
                        users?.map((e, idx) => {
                            return (
                                <div className="dd-user" key={idx}>
                                    ...
                                    <p>{e.name4}</p>
                                    <p>{e.name6}</p>
                                    <p>{e.place ? e.place : 'Kiritilmagan'} </p>
                                    <p>{e.time_ ? e.time_ : "Kiritilmagan"}</p>
