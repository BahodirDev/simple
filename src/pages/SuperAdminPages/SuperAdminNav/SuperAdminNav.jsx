        ...
        <div>
            <div className='sim-nav'>
                <ul className='sv-ul'>
                    ...
                    <NavLink to={'/super-admin/add-worker'} className='nav'><li className='li'>Hodim qo'shishw</li></NavLink>
                    <NavLink to={'/super-admin/'} className='nav'><li className='li'>Hodim qo'shish</li></NavLink>
                </ul>
            </div>
        </div>
    );
